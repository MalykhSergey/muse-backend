...
public class TagSubscribeController {
    ...
    @GetMapping
    public ResponseEntity<Page<TagSubscribeDTO>> getAllTagSubscribe(@RequestParam @Min(0) int page, @RequestParam @Min(1) @Max(100) int size, @AuthenticationPrincipal UserDTO userDTO) {
